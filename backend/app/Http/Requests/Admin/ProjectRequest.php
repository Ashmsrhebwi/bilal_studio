...
class ProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'gallery_images.*'      => ['image', 'mimes:jpeg,jpg,png,webp,gif', 'max:5120'],
            'before_image'          => ['nullable', 'image', 'mimes:jpeg,jpg,png,webp,gif', 'max:5120'],
            'after_image'           => ['nullable', 'image', 'mimes:jpeg,jpg,png,webp,gif', 'max:5120'],
